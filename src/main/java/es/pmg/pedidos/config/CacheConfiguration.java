...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, es.pmg.pedidos.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, es.pmg.pedidos.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, es.pmg.pedidos.domain.User.class.getName());
            createCache(cm, es.pmg.pedidos.domain.Authority.class.getName());
