...
import es.pmg.pedidos.config.Constants;
import es.pmg.pedidos.domain.Authority;
import es.pmg.pedidos.domain.PersistentToken;
import es.pmg.pedidos.domain.User;
import es.pmg.pedidos.repository.AuthorityRepository;
import es.pmg.pedidos.repository.PersistentTokenRepository;
import es.pmg.pedidos.repository.UserRepository;
import es.pmg.pedidos.security.AuthoritiesConstants;
import es.pmg.pedidos.service.MailService;
import es.pmg.pedidos.service.UserService;
import es.pmg.pedidos.service.dto.PasswordChangeDTO;
import es.pmg.pedidos.service.dto.UserDTO;
import es.pmg.pedidos.web.rest.errors.ExceptionTranslator;
import es.pmg.pedidos.web.rest.vm.KeyAndPasswordVM;
import es.pmg.pedidos.web.rest.vm.ManagedUserVM;
