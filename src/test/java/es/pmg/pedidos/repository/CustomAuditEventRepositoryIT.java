...
import es.pmg.pedidos.config.audit.AuditEventConverter;
import es.pmg.pedidos.domain.PersistentAuditEvent;
...
import static es.pmg.pedidos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
