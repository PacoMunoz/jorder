...
import { LineaPedidoComponent } from 'app/entities/linea-pedido/linea-pedido.component';
...
describe('Component Tests', () => {
  describe('LineaPedido Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.lineaPedidos && comp.lineaPedidos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
