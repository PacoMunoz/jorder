...
import { FormaPagoComponent } from 'app/entities/forma-pago/forma-pago.component';
...
describe('Component Tests', () => {
  describe('FormaPago Management Component', () => {
    let comp: FormaPagoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FormaPagoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.formaPagos && comp.formaPagos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
