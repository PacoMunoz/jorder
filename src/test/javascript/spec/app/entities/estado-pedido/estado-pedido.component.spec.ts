...
import { EstadoPedidoComponent } from 'app/entities/estado-pedido/estado-pedido.component';
...
describe('Component Tests', () => {
  describe('EstadoPedido Management Component', () => {
    let comp: EstadoPedidoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EstadoPedidoComponent, '')
        .compileComponents();
